...
//
//
//            var sendMessage = m.setText("Seja bem vindo ao gerenciador escolha uma opção pelo número, tenha um bom dia " +
...
//
//
//            m.setText("agora escolha uma nova localização para o seu bem digitando  o nome no final da lista");
//            listCategory(m, u);
